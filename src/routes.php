...
Route::group(['prefix' => config('lara-config.url_group'), 'namespace' => config('lara-config.namespace', 'Trafik8787\laraCrud2\Controllers'), 'middleware' => config('lara-config.middleware')], function () {
